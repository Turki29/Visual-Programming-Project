...
public class AdminShowDoctors extends JFrame // implements ActionListener
{
    ...
    public AdminShowDoctors() {
        ...
        btnSearch.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (!tfDoctorID.getText().trim().isEmpty()) {
                    queryBuilder.append("id = '").append(tfDoctorID.getText().trim()).append("'");
                    hasCondition = true;
                }
                ...
                if (!tfName.getText().trim().isEmpty()) {
                    ...
                    queryBuilder.append("name LIKE '%").append(tfName.getText().trim()).append("%'");
                    hasCondition = true;
                }
                ...
                if (!tfEmail.getText().trim().isEmpty()) {
                    if (hasCondition)
                        queryBuilder.append(" AND ");
                    queryBuilder.append("email LIKE '%").append(tfEmail.getText().trim()).append("%'");
                    hasCondition = true;
                }
                ...
                if (!tfPhone.getText().trim().isEmpty()) {
                    if (hasCondition)
                        queryBuilder.append(" AND ");
                    queryBuilder.append("phoneNumber LIKE '%").append(tfPhone.getText().trim()).append("%'");
                    hasCondition = true;
                }
        ...
        doctorList = userDb.getUsers(""); // Replace with actual method to get doctors
        if (doctorList != null) {
            for (Person doctor : doctorList) {
                tableModel.addRow(new Object[] {
                        doctor.id,
